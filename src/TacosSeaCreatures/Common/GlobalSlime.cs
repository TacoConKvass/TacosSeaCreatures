...
public class GlobalSlime : GlobalNPC {
	...
	public override bool PreDraw(NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor) {
		if (InABubble) {
			Rectangle sourceRectangle = new Rectangle(0, 0, BubbleTexture.Value.Width, BubbleTexture.Value.Height);
			Main.EntitySpriteDraw(BubbleTexture.Value, npc.Center - screenPos, sourceRectangle, drawColor, 0, sourceRectangle.Center(), npc.scale, SpriteEffects.None);
		}
